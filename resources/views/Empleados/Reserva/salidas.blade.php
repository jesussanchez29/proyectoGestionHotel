                        ...
                        <div class="col-xl-3 col-md-6 mb-4 habitacion-card" data-piso-id="{{ $habitacion->piso_id }}"
                            ...
                            <div class="card border-danger rounded-0">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div
                                                class="text-xs font-weight-bold text-danger text-uppercase mb-1 mt-1">
                                ...
                                <div
                                    ...
                                    <a class="small text-white stretched-link text-uppercase font-weight-bold select-habitacion" href="{{ route('verCrearReservaEmpleado', $habitacion->id) }}">
                                        Ocupada
                                    </a>
