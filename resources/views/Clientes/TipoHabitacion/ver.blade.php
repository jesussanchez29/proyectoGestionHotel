            ...
            <div class="uk-container">
                <div data-uk-grid>
                                                        ...
                                                        <header class="uk-comment-header uk-position-relative">
                                                            <div class="uk-grid-medium uk-flex-middle" data-uk-grid>
                                                                <div class="uk-width-auto">
                                                                    <img class="uk-comment-avatar" src="{{ asset('images/perfilDefecto.png') }}" width="80"
                                                                        height="80" alt="">
                                                                </div>
                                                                <div class="uk-width-expand">
                                                                    <h4 class="uk-comment-title uk-margin-remove"><a
                                                                            class="uk-link-reset"
                                                                            href="#">{{ $resena->usuario->cliente->nombre }} {{ $resena->usuario->cliente->apellidos }}</a>
                                                                    </h4>
                                                                    <ul
                    ...
                    <div class="uk-width-1-3@xl uk-width-1-3@l uk-width-1-3@m uk-width-1-1@s">
                        <!-- booking form -->
                        <div
                            class="bg-color-aqua uk-padding impx-padding-medium uk-margin-medium-bottom uk-box-shadow-medium">
                                                ...
                                                <div
                                                    ...
                                                    <div class="uk-card-media-top">
                                                        ...
                                                        <div
                                                            ...
                                                            <h4
                                                                class="uk-card-title uk-margin-remove-bottom impx-text-white">
