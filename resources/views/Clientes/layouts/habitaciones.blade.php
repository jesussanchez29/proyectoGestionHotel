            ...
            <ul class="uk-child-width-1-2@xl uk-child-width-1-2@l uk-child-width-1-2@m uk-child-width-1-1@s uk-grid-collapse uk-box-shadow-large uk-grid-match impx-rooms-grid"
                                    ...
                                    <div class="uk-card-body uk-position-relative impx-padding-medium">
                                        <div class="uk-card-header uk-padding-remove-horizontal">
                                            ...
                                            <p class="uk-text-meta uk-margin-remove-top">
                                                {{ $tipoHabitacion->descripcion }}</p>
                                        </div>
                                        <span
                                            class="uk-card-badge uk-label bg-color-aqua">{{ $tipoHabitacion->precio }}</span>
                ...
                @if (count($servicios) > 4)
                    <div style="margin:auto;margin-top:30px;">
                        <a href="#" class="uk-button uk-button-default impx-button impx-button-outline">Ver
                            todos los
                            servicios<i class="uk-icon-arrow-circle-o-right"></i></a>
                    </div>
                @endif
            @else
                <p>No disponemos de tipo de habitaciones actualmente</p>
                <!-- Room Item #1 End -->
            @endif
        </ul>
    </div>
